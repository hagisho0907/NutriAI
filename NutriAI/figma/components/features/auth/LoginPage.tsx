    ...
    <div className="min-h-screen bg-gradient-to-b from-secondary to-white flex flex-col items-center justify-center p-8">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="space-y-3">
          <Button onClick={onLogin} className="w-full bg-primary hover:bg-accent">
          ...
          <button onClick={onLogin} className="w-full text-muted-foreground text-sm hover:text-foreground">
            ゲストモードで試す
          </button>
        </div>
