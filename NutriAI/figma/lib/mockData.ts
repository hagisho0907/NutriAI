...
export interface Task {
  type: 'log_meal' | 'log_exercise' | 'log_weight';
...
export interface ExerciseTemplate {
  id: string;
  name: string;
  category: 'cardio' | 'strength' | 'mobility' | 'other';
  metValue: number;
...
// Custom meal (combination of foods)
...
export const mockDailySummary: DailySummary = {
  ...
  targetCarbG: 200,
  tasks: [
    { type: 'log_meal', status: 'pending', title: '朝食を記録する' },
    { type: 'log_meal', status: 'pending', title: '昼食を記録する' },
...
// Helper functions
export const calculatePFCPercentages = (summary: DailySummary) => {
...
export const mockCustomMeals: CustomMeal[] = [
  {
    id: 'cm-1',
    name: '朝の定番セット',
