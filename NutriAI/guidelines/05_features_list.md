...
| F-03 | 食事記録(写真AI推定) | 写真+補足からマクロ栄養素を推定し登録負担を最小化 | SCR-04 | meals, meal_items, foods, ai_inferences | `POST /ai/meals/estimate`, `POST /meals`, `POST /meals/{id}/photo` | 画像アップロードはモックURLで代替 |
